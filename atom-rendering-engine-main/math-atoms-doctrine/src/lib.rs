...
const GATES: &[Gate] = &[
    ...
    Gate {
        title: "Stack order",
        body: "The atom stack order is a hard performance contract, not an unordered tag list.",
        layer: "L3",
    },
];
...
const MISSION: Mission = Mission {
    ...
    body: "Build the requested app through native atom rendering, canonical atom stacks, Spiderweb Bus routing, graph evidence, provider calls when required, and proof artifacts that match the actual user request.",
